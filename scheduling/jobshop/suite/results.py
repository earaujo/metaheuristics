...
def process_file(file_name):
    ...
    for line in results_file:
        ...
        local_values = {"Best of all": values[0],
                        "Best mean": values[1],
                        "Worst of all": values[2],
                        "Populations fitness mean": values[3],
                        "Population size": values[4],
                        "Interval mean": values[5],
                        "Evaluations mean": values[6]}
